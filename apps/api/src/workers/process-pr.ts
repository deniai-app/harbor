...
async function buildReviewingComment(params: {
  ...
  return [
    ...
    "<!-- auto-generated by PR review automation -->",
    "",
    "## Review in progress...",
    "",
    coreBody,
...
function buildCompletedReviewingComment(params: {
  ...
  const statusLine = params.error ? "## Review encountered an error" : "## Review finished";
...
function buildInProgressReviewingCheckOutput(params: {
  ...
  return {
    ...
    summary: `${params.owner}/${params.repo}#${params.pullNumber} review is in progress.`,
